...
1.  [`db_compute_bins()`](https://edgararuiz.github.io/dbplot/reference/db_compute_bins.md) -
    Returns a data frame with the bins and count per bin
2.  [`db_compute_count()`](https://edgararuiz.github.io/dbplot/reference/db_compute_count.md) -
    Returns a data frame with the count per discrete value
3.  [`db_compute_raster()`](https://edgararuiz.github.io/dbplot/reference/db_compute_raster.md) -
    Returns a data frame with the results per x/y intersection
4.  [`db_compute_raster2()`](https://edgararuiz.github.io/dbplot/reference/db_compute_raster.md) -
    Returns same as
...
5.  [`db_compute_boxplot()`](https://edgararuiz.github.io/dbplot/reference/db_compute_boxplot.md) -
